...
<body>
    <div class="mail-container">
        <header class="">
            <h1>Reset your zauto<span style="color: #9752FC ;">ai</span> account password</h1>
        </header>
        <section class="mail-body">
            <h2>Dear {{name}},</h2>
            <p>You have requested to reset your ZautoAI accountpassword.</p>
            <p>Click the button below to let us know it's really you and reset your password.</p>
            <p>Please note, this link is only valid for 24 hours.</p>
            <a href="{{link}}" class="anc" style="background: #45226f;">Reset your password</a><br/>

...
1. Fit: The contact fully matches the criteria of any ICP.
2. Partially Fit: The contact matches some but not all of the criteria of any ICP.
3. Unfit: The contact does not match the criteria of any ICP.
...
- If the contact is "ICP Unfit," assign it to either "Inbound Default" or "Outbound Default" based on the contact's information don't assign to any other ICP.
...
{
    "id": "ICP_ID under which the contact falls if none then ICP_ID of either "Inbound Default" or "Outbound Default" based on the contact's information",
    "category": "ICP category(FIT,PARTIALLY_FIT,UNFIT)",

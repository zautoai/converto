...
export class AccountsController {
  ...
  @Get()
  @ApiOperation({ description: 'Get All Accounts', summary: 'Get All Accounts' })
  ...
  @Get(':id')
  @ApiOperation({ description: 'Get Account By Id', summary: 'Get Account By Id' })
  ...
  update(@Param('id') id: string, @Body() updateAccountDto: UpdateAccountDto, @Req() req:IRequest) {
    if(req.orgId)
    {
      const orgId = req.orgId;
